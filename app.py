...
# Load a second sample picture and learn how to recognize it.
#atakan_image = face_recognition.load_image_file("Atakan/Atakan.jpg")
#atakan_face_encoding = face_recognition.face_encodings(atakan_image)[0]

# Create arrays of known face encodings and their names
known_face_encodings = [
    krish_face_encoding,
    bradley_face_encoding
    #atakan_face_encoding
]
known_face_names = [
    "Krish",
    "Bradly"
